<template>
  <div>
    ...
    <p class="center" v-else-if="!categories.length"> No categories. <router-link
    to="/categories">Add new category</router-link></p>

    <section v-else>
      <div v-for="cat of categories" :key="cat.id">
        <p>
          <strong v-tooltip="cat.tooltip">{{ cat.title }}:</strong>
